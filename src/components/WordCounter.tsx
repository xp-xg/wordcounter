...
const WordCounter = () => {
  ...
  useStructuredData({
    ...
    description:
      "Free online tool to count words, characters, and sentences instantly. Ideal for writers, students, and bloggers.",
  ...
  const keywordDensity = useMemo(
    () => getKeywordDensity(debouncedText),
    [debouncedText]
  );
  ...
  // Load Adsterra 728x90 Banner at the bottom after component mounts
  useEffect(() => {
    const loadAdsterra728x90 = () => {
      const container = document.getElementById("adsterra-bottom-banner");
      if (container) {
        const script = document.createElement("script");
        script.type = "text/javascript";
        script.innerHTML = `
    ...
    // Load the bottom banner after a delay to ensure DOM is ready
    const timer = setTimeout(() => {
      loadAdsterra728x90();
    }, 500);
  ...
  // Load Adsterra Native Banner after component mounts
  useEffect(() => {
    const loadAdsterraNative = () => {
      const container = document.querySelector(
        "#container-05e96df38241a2f448ce27b19e32317b"
      );
      if (container) {
        const script = document.createElement("script");
        script.async = true;
        ...
        script.src =
          "//pl27942032.effectivegatecpm.com/05e96df38241a2f448ce27b19e32317b/invoke.js";
        container.appendChild(script);
      }
    };

    // Load the native banner after a delay to ensure DOM is ready
    const timer = setTimeout(() => {
      loadAdsterraNative();
    }, 250);
  ...
  return (
    <>
      ...
      <Card>
        <CardContent sx={{ p: 4 }}>
          ...
          >
            {t(
              "whyUseWordCounter",
              "Paste your text below to get instant word and character counts. Perfect for writers, students, and bloggers who need to meet specific word limits for essays, blog posts, and social media content."
            )}
          </Typography>
      ...
      {/* Adsterra 300x250 Banner - Between How to Use and Learn More About Text Analysis */}
      <Box sx={{ my: 3, textAlign: "center" }}>
