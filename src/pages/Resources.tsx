...
const Resources = () => {
  ...
  useEffect(() => {
    const loadAdsterraResourcesBanner = () => {
      const container = document.getElementById("adsterra-resources-banner");
      if (container) {
    ...
    <Container maxWidth="md" sx={{ my: 4 }}>
      <Paper sx={{ p: 4, backdropFilter: 'blur(10px)', backgroundColor: 'rgba(255, 255, 255, 0.1)' }}>
        <Box sx={{ my: 2, textAlign: "center" }}>
          <div id="adsterra-resources-banner"></div>
        </Box>
